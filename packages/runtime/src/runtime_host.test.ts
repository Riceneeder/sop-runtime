...
import {AcceptedStepResult, Decision, JsonObject, SopDefinition, StepResult} from '@sop-runtime/definition';
import {
...
async function expectRuntimeErrorCode(
...
function buildDefinitionWithExecutor(
